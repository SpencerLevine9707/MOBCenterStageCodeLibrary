...
//public class AutonRedBeforeTrussOLDBOT extends LinearOpMode {
...
//            follower.goToPoints(true, MonkeyMapOLDBOT.velForTurn);
//            wBot.knockStack();
//            sleep(MonkeyMapOLDBOT.sleepTimeKnockStack);
//            wBot.resetKnocker();
//
//            posesToGoTo.clear();
...
//            follower.reinit(posesToGoTo);
//            follower.goToPoints(true);
//            sleep(MonkeyMapOLDBOT.sleepTimePickUpPixel);
//
