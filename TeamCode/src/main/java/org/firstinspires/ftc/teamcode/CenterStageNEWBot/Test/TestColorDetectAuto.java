...
public class TestColorDetectAuto extends LinearOpMode {
    OpenCvCamera webcam;
    static DavidBoxCodeForPropDetect colorPipe;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        colorPipe = new DavidBoxCodeForPropDetect(telemetry, OpenCVGreatestColorTest.lowerBlue, OpenCVGreatestColorTest.upperBlue);
...
//            telemetry.addData("Corrector Servo Pos", correctorPosFirstPlace);
