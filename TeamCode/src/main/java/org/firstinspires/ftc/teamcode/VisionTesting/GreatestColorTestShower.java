...
@Config
@Autonomous(group = "")
public class GreatestColorTestShower extends LinearOpMode {
    OpenCvCamera webcam;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()){
            telemetry.addData("xDist ", OpenCVGreatestColorTest.xDist);
            telemetry.addData("Center x ", OpenCVGreatestColorTest.centerX);
            telemetry.addData("xDist + math", OpenCVGreatestColorTest.xDist * MonkeyMap.lineDist + MonkeyMap.offsetForPickUp);
            telemetry.update();
//            webcam.setPipeline(pipeline);
//            timeForAuton.reset();
//            wBot.closeGrabber();
