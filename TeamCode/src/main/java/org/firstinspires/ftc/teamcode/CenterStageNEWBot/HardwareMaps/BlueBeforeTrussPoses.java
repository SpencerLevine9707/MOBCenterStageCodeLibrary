...
public class BlueBeforeTrussPoses {
    ...
    public static double xPosFirstPlacementAfter = 47, yPosFirstPlacementAfterBeacon1 = 31, yPosFirstPlacementAfterBeacon2 = 22, yPosFirstPlacementAfterBeacon3 = 21;
    ...
    public static double xPosGoAcrossForBeforeTrussPurplePixelClose = -34, yPosGoAcrossForBeforeTrussPurplePixelClose = 42;
    ...
    //Park Poses
    public static double xPosParkTriangle = 57, yPosParkTriangle = 3;
    public static double xPosLineUpParkTriangle = 40, yPosLineUpParkTriangle = 3;
    public static double xPosParkSquare = 57, yPosParkSquare = 52;
    public static double xPosLineUpParkSquare = 40, yPosLineUpParkSquare = 52;
