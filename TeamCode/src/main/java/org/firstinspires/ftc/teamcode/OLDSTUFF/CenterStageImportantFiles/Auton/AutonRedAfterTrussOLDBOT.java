...
//public class AutonRedAfterTrussOLDBOT extends LinearOpMode {
...
//    ActionRunnerCenterStageAutonOLDBOT actionRunner = new ActionRunnerCenterStageAutonOLDBOT(this, wBot);
...
//            wBot.unloadPixel();
//            sleep(MonkeyMapOLDBOT.sleepTimePlacePreloadBeacon);
//            wBot.stopLoadingPixels();
//
//            posesToGoTo.clear();
//            wBot.placeSlidesFirstTime();
//            if(zoneDetected == 1){
//                posesToGoTo.add(new PosesAndActions(wBot.lineUpForFirstPlacementAfterTruss, ""));
//            }
//            if(zoneDetected == 2){
...
//            follower.goToPoints(true);
//            wBot.openGrabber();
//            sleep(MonkeyMapOLDBOT.sleepTimePlacePixels);
//            wBot.flipUpAndRotate();
//            sleep(MonkeyMapOLDBOT.sleepTimeFlipForFirstPlaceAfterTruss);
//            wBot.placeSlides();
//            sleep(MonkeyMapOLDBOT.sleepTimePutSlidesUpNoBreakFlipper);
//
