...
public class DavidConceptVision extends OpenCvPipeline {
    ...
    Mat HSV = new Mat();
    public static double anchorPointX1 = 50;
    public static double anchorPointY1 = 50;

    public static double anchorPointX2 = 130;
    public static double anchorPointY2 = 100;
    ...
    Mat region2;
    Telemetry telemetry;
    public static int roomForErrorColor = 20;
    ...
    public static int[] lowerBlue = {90, 50, 50};
    public static int[] upperBlue = {130, 255, 255};

        // Make a Constructor
    public DavidConceptVision(Telemetry telemetry) {
...
//        }
    ...
    public boolean isInRange(int[] hsv_value){
        return hsv_value[0] >= lowerBlue[0] && hsv_value[0] <= upperBlue[0];
    }
}
